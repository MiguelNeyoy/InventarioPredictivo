...
class ValidadorDatos:
    ...
    def validar_y_limpiar(self, df_crudo):
        ...
        if df_limpio.empty:
            raise ValueError("El DataFrame quedo vacio despues de limpiar valores nulos.")
        ...
        try:
            ...
            raise ValueError(f"No se pudieron convertir las fechas. Asegurate del formato correcto. Detalle: {e}")
